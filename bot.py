...
@client.event
async def on_ready():
    print("البوت يعمل بالنسخة النهائية المحدثة")
        ...
        for attachment in message.attachments:
            if attachment.filename.lower().endswith((".png", ".jpg", ".jpeg", ".webp")):
                ...
                try:
                    ...
                    # استخدام الإصدار v1beta مع نموذج gemini-1.5-flash وتمرير المفتاح في الـ Headers
                    ...
                    if "candidates" in result:
                        ...
                        await message.channel.send(f"خطأ من جوجل: {err_text}")
